...
export const IndexViscosity = () => {
  ...
  const description =
    ...
    "При нескольких строках внутри одного расчёта усредняются валидные значения по каждой температуре, " +
    "затем вычисляется индекс вязкости (как в калькуляторе вязкости по ГОСТ 33)."
